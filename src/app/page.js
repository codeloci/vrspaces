...
const App = () => {
  ...
  const handleSegmentChange = (value) => {
    ...
    console.log(value)
    // Scroll to the corresponding section based on the selected index
    switch (value) {
      case "Home":
  ...
  return (
    <>
      <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', backgroundColor: "white" }}>
        ...
        <div style={fullPageStyle} ref={homeRef} id={"home"}>
        ...
        <div style={secondSectionStyle} ref={aboutRef} id={"about"}>
        ...
        <div style={thirdSectionStyle} ref={serviceRef} id={"service"}>
        ...
        <div style={thirdSectionStyle} ref={contactRef} id={"contact"}>
